...
def recognize_devices(collected_data, uuid):
    ...
    recorded_devices = ['usbdisk', 'virtualprinters','usbprinters', 'scanners', \
                        ...
                        'barcodescanner','smartcardreader','wirelessmouse','wirelesskeyboard']
